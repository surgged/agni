...
// Temporal activities. Registering the value (w.RegisterActivity(a))
// exposes every exported method by its method name.
//
// Methods live in separate per-concern files:
//
//	activities_transitions.go — MarkBuilding, MarkDeploying
