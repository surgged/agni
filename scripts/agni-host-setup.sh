...
echo ""
echo "This cluster only runs kata/firecracker user workloads."
echo "The agni API, databases, and other platform services are deployed elsewhere."
echo ""
echo "Next steps:"
echo "  1. Set up DNS A record for your domain (e.g., YOUR_DOMAIN) → $(hostname -I | awk '{print $1}')"
echo "  2. Run scripts/e2e-k3s.sh to set up the pull secret and deploy the platform stack"
