  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Verify Your Email - Agni</title>
      </head>
      <body
        style={{
          margin: 0,
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ paddingBottom: '32px' }}>
                        ...
                        >
                          Welcome to Agni! Verify{' '}
                          <strong style={{ color: '#d4d4d8' }}>
                            {recipientEmail}
                          </strong>{' '}
                          to activate your account and start deploying Kata
                          MicroVM sandboxes.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style={{ paddingTop: '32px' }}>
                        ...
                        >
                          If you didn't create an Agni account, you can safely
                          ignore this email.
                        </p>
                      </td>
                    </tr>
